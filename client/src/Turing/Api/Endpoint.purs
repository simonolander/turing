-- | Turing uses a REST API for resource management. This module defines endpoints in a data type
...
-- |
-- | This module takes the same approach as the `Turing.Data.Route` module. For a more in-depth
...
module Turing.Api.Endpoint where
...
import Turing.Data.Comment (CommentId)
import Turing.Data.Route (slug, uname)
