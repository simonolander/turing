-- | We use datetimes all over the place in Turing to describe when a resource like a comment
...
-- | representation.
module Turing.Data.PreciseDateTime where
...
-- | Display a human-readable version of the precise datetime, as described in the Turing spec
-- |
