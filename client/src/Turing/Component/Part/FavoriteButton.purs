-- | The favorite buttons in Turing don't have enough encapsulated state or behaviors to be a full
...
-- |
-- | For a more in-depth example of this pattern, see the `Turing.Component.Part.FollowButton`
-- | module.
module Turing.Component.Part.FavoriteButton
  ( ButtonSize(..)
  , favoriteButton
  , favorite
  , unfavorite
...
import Turing.Capability.Resource.Article (class ManageArticle, favoriteArticle, unfavoriteArticle)
