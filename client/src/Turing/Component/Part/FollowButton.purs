-- | The follow buttons in Turing don't have enough encapsulated state or behaviors to be a full
...
module Turing.Component.Part.FollowButton
  ( followButton
  , follow
  , unfollow
  ) where
...
import Turing.Capability.Resource.User (class ManageUser, followUser, unfollowUser)
import Turing.Component.HTML.Utils (css)
import Turing.Data.Profile (Author, Relation(..))
